...
<div class="content-wrapper">
  ...
  <div class="row mart10 padd">
    ...
    <div class="col-md-4">
      <a class="btn btn-primary btn-sm float-right" href="{{url('admin/opening')}}">Manage Opening</a>
    </div>
  </div>
        ...
        <div class="col-12">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">Edit Opening</h3>
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{url('admin/updateOpening')}}" enctype="multipart/form-data">
