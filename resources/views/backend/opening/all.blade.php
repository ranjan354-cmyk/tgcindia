...
@section('content')
  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          <a class="btn btn-primary btn-sm float-right" href="{{url('admin/add-opening')}}">Add New Opening</a>
        </div>
          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Opening Management</h3>
                        ...
                        <td>  
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{url('admin/edit-opening/')}}/{{$pgs->id_hash}}">Edit</a>
                                <a onclick="return confirm('Are you sure you want to delete this item?');" class="dropdown-item" href="{{url('admin/delete-opening')}}/{{$pgs->id}}"">Delete</a>
                            </div>
                          </div>
                        </td>
