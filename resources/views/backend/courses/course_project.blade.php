          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Course Project </h3>
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/insertProject')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{url('admin/course-heading/'.$category->id_hash)}}" class="btn btn-primary">Next</a>
                      ...
                      <tr>
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="{{url('admin/course-project-edit')}}/{{$cat->id}}/{{$category->id}}">Edit</a>

                            <a onclick="return confirm('Are you sure you want to delete this item?');" class="dropdown-item" href="{{url('admin/delete-project')}}/{{$cat->id}}/{{$cat->image}}">Delete</a> 
