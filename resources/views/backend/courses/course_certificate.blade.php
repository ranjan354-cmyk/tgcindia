...
@section('content')
          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/insertCertificate')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <label>Image(Press ctrl button and select multiple images)</label>

                      <input type="file" class="form-control" name="image[]" multiple required>

                    </div>
                    <p class="custom-text" style="color: red;">Image Size Should be	150 × 60 px</p>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{url('admin/course-syllabus/'.$data['id_hash'])}}" class="btn btn-primary">Next</a>
 ...
 <th>Order By</th>
  ...
  <td>
      <input type="number" value="{{$cat->order_by}}"  onchange="orderChange(this.value,'{{$cat->id}}')">
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="{{url('admin/course-certificate-edit')}}/{{$cat->id}}/{{$category->id}}">Edit</a>
...
<script>
    function orderChange(id,srno){
        console.log(srno);
          $.ajax({
        url: '{{ url("admin/saveCertificateOrder") }}', // Use route name for better practice
        type: 'POST',
        data: {
