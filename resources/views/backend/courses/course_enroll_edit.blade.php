          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Update Course Enroll</h3>
              ...
              <div class="card-body">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                  ...
                  <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/course-training/'.$data['id_hash'])}}">Tools Covered</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/course-solutions/'.$data['id_hash'])}}">Skills Covered</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="{{url('admin/course-certificate/'.$data['id_hash'])}}">Certificates</a>
                    </li>
                    <li class="nav-item">
                ...
                <form method="post" action="{{url('admin/updateEnroll')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" value="{{$enroll->name}}" >
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="description" required value="{{$enroll->description}}" >
                  ...
                  <div class="col-md-2">
                    ...
                    <p class="custom-text" style="color: red;">Image Size Should be	40 × 35 px</p>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="image_alt" value="{{$enroll->image_alt}}" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="image_title" value="{{$enroll->image_title}}" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="image_description" value="{{$enroll->image_description}}" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{url('admin/course-training/'.$category->id_hash)}}" class="btn btn-primary">Next</a>
