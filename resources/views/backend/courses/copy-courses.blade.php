          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Copy Course Management</h3>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            ...
                            $dataExploded = explode(" in ", $popValue->name);

///print_r($dataExploded);

echo $dataExploded[0]." in ".$dataExploded[1];
...
<script>
  new DataTable('#example', {
    pageLength: 1000,           // show 1000 rows by default
    lengthMenu: [10, 25, 50, 100, 500, 1000], // options in the select box
    layout: {
        bottomEnd: {
            paging: {
                firstLast: false // hide first/last buttons
            }
        }
    }
});
