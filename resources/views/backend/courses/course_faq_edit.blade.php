          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Update Course Faq</h3>
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/updateFaqCourse')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" required value="{{$faq->name}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="description" value="{{$faq->description}}" >
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="checkbox-group" style="display: flex; flex-wrap: wrap;">
                            @php                               
                                $selectedCategories = explode(',', $faq->new_faq);
                            @endphp
                
                            
                                <div style="margin-right: 15px;">
                                    <input type="checkbox" name="new_faq[]" value="description"
                                        {{ in_array("description", $selectedCategories) ? 'checked' : '' }}> Description
                                    
                                </div>
                                <div style="margin-right: 15px;">
                                  <input type="checkbox" name="new_faq[]" value="Certification"
                                      {{ in_array("Certification", $selectedCategories) ? 'checked' : '' }}> Certification
                                  
                              </div>
                              <div style="margin-right: 15px;">
                                <input type="checkbox" name="new_faq[]" value="CertificationFAQs"
                                    {{ in_array("CertificationFAQs", $selectedCategories) ? 'checked' : '' }}> CertificationFAQs
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{url('admin/course-certificate-training/'.$category->id_hash)}}" class="btn btn-primary">Next</a>
