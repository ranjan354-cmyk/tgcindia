        ...
        <div class="col-12">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{url('admin/updateBatch')}}" enctype="multipart/form-data" >
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="name" required value="{{$batch->name}}">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="type"   value="{{$batch->type}}">
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="batch_type" required>
                        ...
                        <option value="{{$batch->batch_type}}">{{$batch->batch_type}}</option>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="fast_filling" >
                        ...
                        <option value="{{$batch->fast_filling}}">{{$batch->fast_filling}}</option>
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="start_date" min="{{date('Y-m-d')}}" required value="{{$batch->start_date}}"> 
                  ...
                  <div class="col-md-2">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="batch_fee" value="{{$batch->batch_fee}}">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{url('admin/course-enroll/'.$category->id_hash)}}" class="btn btn-primary">Next</a>
