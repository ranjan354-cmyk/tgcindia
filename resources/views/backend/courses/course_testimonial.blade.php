          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Course Testimonial </h3>
<form method="post" action="{{route('saveCourseBulkTestimonials')}}">
    @csrf
    <input type="hidden" name="id" value="{{$category->id}}">
     <input type="hidden" name="cat_id" value="{{$category->parent}}">
<div class="row">
    <div class="col-md-3">
        <button class="btn btn-primary" type="submit">Bulk Assign</button>
    </div>
</div>
</form>
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/insertTestimonial')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <p class="custom-text" style="color: red;">Image Size Should be	40 × 40 px</p>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{url('admin/course-project/'.$data['id_hash'])}}" class="btn btn-primary">Next</a>
                      ...
                      <tr>
                        ...
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="{{url('admin/course-testimonial-edit')}}/{{$cat->id}}/{{$category->id}}">Edit</a>

                            <a onclick="return confirm('Are you sure you want to delete this item?');" class="dropdown-item" href="{{url('admin/delete-testimonial-course')}}/{{$cat->id}}">Delete</a> 
