          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Update Course Certificate</h3>
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/updateCertificate')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <p class="custom-text" style="color: red;">Image Size Should be	440 × 310 px</p>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <a href="{{url('admin/course-syllabus/'.$category->id_hash)}}" class="btn btn-primary">Next</a>
