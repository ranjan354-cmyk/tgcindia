  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          ...
          <a class="btn btn-primary btn-sm float-right" href="{{url('admin/partner')}}">Manage Partner</a>
          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/updatePartner')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="url" required value="{{$page->url}}">
