  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          ...
          <a class="btn btn-primary btn-sm float-right" href="{{url('admin/review-category')}}">Manage Category</a>
          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/updateReviewCategory')}}" enctype="multipart/form-data">
