...
@section('content')
  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          <a class="btn btn-primary btn-sm float-right" href="{{url('admin/add-review-category')}}">Add New Category</a>
        </div>
                  ...
                  <table class="table table-hover text-nowrap1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$cat->name}}</td>
                        <td>{{$cat->icon}}</td>
                        <td><img src="{{url('public/uploads/'.$cat->image)}}" /></td>
                        <td>{{$cat->staus}}</td>
                        ...
                        <td>  
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{url('admin/edit-review-category/')}}/{{$cat->id_hash}}">Edit</a>
                                <a onclick="return confirm('Are you sure you want to delete this item?');" class="dropdown-item" href="{{url('admin/delete-review-category')}}/{{$cat->id}}"">Delete</a>
                            </div>
                          </div>
                        </td>
