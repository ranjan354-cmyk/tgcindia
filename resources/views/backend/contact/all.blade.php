...
@section('content')
  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          <!--<a class="btn btn-primary btn-sm float-right" href="{{url('admin/add-contact')}}">Add New Contact</a>-->
        </div>
                  ...
                  <table class="table table-hover text-nowrap1">
                    <thead>
                      <tr>
                        ...
                        <th>Phone Number(Course Page)</th>
                        <th>Image(Blog Page)</th>
                        <th>Date Added</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>{{$i+1}}</td>
                        <td>{{$pgs->phone_number}}</td>
                        <td>{{$pgs->email}}</td>
                        <td>{{$pgs->whatsapp_num}}</td>
                        <td>{{$pgs->course_page_number}}</td>
                        <td>
                             <img src="{{url('public/uploads/'.$pgs->image)}}" class="img-fluid">
                        </td>
                        ...
                        <td>  
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{url('admin/edit-contact/')}}/{{$pgs->id_hash}}">Edit</a>
                                <!--<a onclick="return confirm('Are you sure you want to delete this item?');" class="dropdown-item" href="{{url('admin/delete-contact')}}/{{$pgs->id}}">Delete</a>-->
                            </div>
                          </div>
                        </td>
