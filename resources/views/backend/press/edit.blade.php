  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          ...
          <a class="btn btn-primary btn-sm float-right" href="{{url('admin/press')}}">Manage Press</a>
          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Edit Press</h3>
              ...
              <div class="card-body">
                ...
                <form method="post" action="{{url('admin/updatePress')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <p class="custom-text" style="color: red;">Image Size Should be 130 × 130 px</p>
