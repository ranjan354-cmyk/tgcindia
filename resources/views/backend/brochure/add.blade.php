                ...
                <div class="col-12">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-header">
                            ...
                            <h3 class="card-title">Add Brochure</h3>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{url('admin/saveBrochure')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select class="form-control" name="catid">
                                               ...
                                               @foreach($courseCate as $courseCateValue)
                                                 <option value="{{$courseCateValue->id}}">{{$courseCateValue->name}}</option>
                                                 @endforeach
