          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">Deleted Category </h3>
                        ...
                        <td>  
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a onclick="return confirm('Are you sure you want to Restore this item?');" class="dropdown-item" href="{{url('admin/restore-course-category')}}/{{$cat->id}}"">Restore</a>
                            </div>
                          </div>
                        </td>
