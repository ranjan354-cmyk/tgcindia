...
<div class="content-wrapper">
  ...
  <div class="row mart10 padd">
    ...
    <div class="col-md-4">
      ...
      <a class="btn btn-primary btn-sm float-right" href="{{url('admin/placement')}}">Manage Placement</a>
        ...
        <div class="col-12">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              ...
              <form method="post" action="{{url('admin/updatePlacement')}}" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="course_name" value="{{$page->course_name}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="type" value="{{$page->type}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="student_from" value="{{$page->student_from}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <label>Student To</label>

                      <input type="text" class="form-control" name="student_to" value="{{$page->student_to}}">
                  ...
                  <div class="col-md-6">
                    ...
                    <p class="custom-text" style="color: red;">Image Size Should be 105 × 105 px</p>
