  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          ...
          <a class="btn btn-primary btn-sm float-right" href="{{url('admin/add-placement')}}">Add New Placement</a>
          ...
          <div class="col-12">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-header">
                ...
                <h3 class="card-title">Placement Management</h3>
                  ...
                  <table class="table table-hover text-nowrap1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{$pgs->student_from}}</td>

                        <td>{{$pgs->student_to}}</td>
                        ...
                        <td>  
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="{{url('admin/edit-placement/')}}/{{$pgs->id_hash}}">Edit</a>

                                <a onclick="return confirm('Are you sure you want to delete this item?');" class="dropdown-item" href="{{url('admin/delete-placement')}}/{{$pgs->id}}">Delete</a>
