...
@section('content')
  ...
  <div class="content-wrapper">
   ...
   <div class="row mart10 padd">
        ...
        <div class="col-md-4">
          <a class="btn btn-primary btn-sm float-right" href="{{url('admin/add-reviews')}}">Add New Reviews</a>
        </div>
                  ...
                  <table class="table table-hover text-nowrap1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          @php
                            $results = DB::table('tbl_review_category')->where('id', $pgs->type)->first();
                            if($results){
                              echo $results->name;
                            }
                           @endphp
                        ...
                        <td>
                          @php
                            $results = DB::table('tbl_course_category')->where('id', $pgs->course_category)->first();
                            if($results){
                              echo $results->name;
                            }
                           @endphp
                        ...
                        <td>  
                          ...
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="{{url('admin/edit-reviews/')}}/{{$pgs->id_hash}}">Edit</a>
                                <a onclick="return confirm('Are you sure you want to delete this item?');" class="dropdown-item" href="{{url('admin/delete-reviews')}}/{{$pgs->id}}"">Delete</a>
                            </div>
                          </div>
                        </td>
