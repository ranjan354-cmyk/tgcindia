...
<section class="cor_po">
		...
		<img src="{{url('assets/front/')}}/img/press-release.webp">
		...
		<div class="tophead-form">
			...
			<div class="container">
				...
				<div class="title-head-b2b">
					...
					<p class="subhead-b2bhome">Official announcements, partnerships, and media coverage from TGC India.
</p>
...
@php foreach($data['press'] as $row){ @endphp

<div class="row iItm">
<div class="col-md-3 mar_pad">
<div class="newsleftsec">
<div class="newsimgsec">
<img src="{{url('public/uploads/'.$row->image)}}" alt="{{$row->image_alt}}" title="{{$row->image_title}}" description="{{$row->image_description}}">
</div>
<div class="newsinfosec">
<span class="newslabel">CXOtoday.com</span>
<span class="newspostdate">23 May, 2024</span>
<div class="newssharesec">
...
<div class="col-md-9 mar_pad">
<div class="padd_ddf">
<h1 class="newsheading">
<a target="_blank" rel="noopener noreferrer nofollow" href="{{url('press/'.$row->slug)}}">{{$row->name}}</a>
</h1>
<p class="newsdesc">
@php echo $row->short_content; @endphp

Tgc's DevOps training program will provide you with in-depth knowledge of various DevOps tools, including Git, Jenkins, Docker, Ansible, Terraform, Kubernetes, Prometheus, and Grafana. This DevOps certification course is entirely hands-on and designed to help you become a certified practitioner through best practices in Continuous Development, Configuration Management, and Integration, and finally, Continuous Monitoring of software throughout its development life cycle. This live instructor-led training program helps you work on LIVE projects.

</p>
<a target="_blank" class="read_more" rel="noopener noreferrer nofollow" href="{{url('press/'.$row->slug)}}">Read More

<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"><path fill="color" fill-rule="evenodd" d="M10.159 10.72a.75.75 0 1 0 1.06 1.06l3.25-3.25L15 8l-.53-.53l-3.25-3.25a.75.75 0 0 0-1.061 1.06l1.97 1.97H1.75a.75.75 0 1 0 0 1.5h10.379z" clip-rule="evenodd"/></svg>
