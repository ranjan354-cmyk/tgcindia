...
<div class="main-content">
	...
	<section class="news_bread">

		<div class="container">

			<div class="news_heading">

				<h3>{{$data['press']->name}}</h3>

				<ul>



					<li><a href="{{url('press-release.html')}}"> Press Release</a></li>

					<li>{{$data['press']->name}}</li>
				...
				<div class="col-md-9">
					...
					<div class="content">
						...
						<div class="news_content">
							...
							<p><img src="{{url('public/uploads/'.$data['press']->image)}}" alt="{{$data['press']->image_alt}}" title="{{$data['press']->image_title}}" description="{{$data['press']->image_description}}"></p>



							@php echo $data['press']->content; @endphp
...
<input type="hidden" name="form_start" value="{{ now()->timestamp }}">
										...
										<input type="hidden" name="form_type" value="Press_Release_details">
