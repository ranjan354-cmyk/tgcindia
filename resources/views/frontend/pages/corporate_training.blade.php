		...
		<div class="tophead-form">
			...
			<div class="container">
				...
				<div class="title-head-b2b">
					...
					<a class="trackButton demo-req-btn ga_corp_info" href="{{url('contact-us.html')}}">CONNECT WITH US</a>
				...
				<div class="col-sm-6 col-xs-12 corpfeatleft">
					...
					<a class="featcardmain">
						...
						<div class="leftfeatcontentsec">
							...
							<span class="visible-xs closemodal"><i class="icon-cross"></i></span>
