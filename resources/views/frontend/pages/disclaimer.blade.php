      ...
      <div class="row">
        ...
        <div class="col-md-9">
          ...
          <div class="policy_content">
            ...
            <p>The contents of this website are created and maintained by Total Graphics Classes Pvt Ltd. Despite all reasonable efforts to maintain accurate and complete information, it is not possible to guarantee the current accuracy or completeness of the information on this website Total Graphics Classes Pvt Ltd participating educational partners therefore expressly reserve the right to deviate from what appears in this website, in whole or in part. Without limiting the generality of the foregoing, this may include changes to programs, courses, fees, regulations and policies or schedules.</p>



            <p>The views expressed on this website do not necessarily reflect those of the Ontario Ministry of Training, Colleges and Universities.</p>
            ...
            <div class="form-column">
              ...
              @if(session('success13'))
									...
									@csrf
										...
										<input type="hidden" name="form_type" value="disclaimer">
