...
<div class="main-content">
	...
	<section class="corp-banner">
		...
		<img src="{{url('assets/front/')}}/img/visa_assistance_tgc.png" alt="TGC India reviews">
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="content">
						...
						<h3>I still have some questions in my mind?</h3>

						<p>If you have any queries other than the above, please feel free to contact us through phone or mail:</p>



						<p>Email: info@tgcindia.com, Phone no.: +91 9015345149, +91 9810031162</p>
						...
						<div class="form-column">
							...
							@if(session('success13'))
									...
									<input type="hidden" name="recaptcha_token" class="recaptcha_token">
										...
										<input type="hidden" name="form_type" value="visa_assistance">
