...
<head>
   ...
   <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css"> 
    ...
    <!----<link href="{{ url('assets/front/') }}/css/jquery-ui.min.css" rel="stylesheet" type="text/css"> --->
     ...
     <link rel="preload" href="{{ url('assets/front/') }}/css/css-plugin-collections.css" as="style" onload="this.onload=null;this.rel='stylesheet'"><noscript><link href="{{ url('assets/front/') }}/css/css-plugin-collections.css" rel="stylesheet"></noscript> 
...
<!--
   ...
   <!-- <link href="{{ url('assets/front/') }}/css/custom-bootstrap-margin-padding.css" rel="stylesheet" type="text/css"> ---->
    ...
    <link rel="preload" href="{{ url('assets/front/') }}/css/responsive.css" as="style" onload="this.onload=null;this.rel='stylesheet'"><noscript><link href="{{ url('assets/front/') }}/css/responsive.css" rel="stylesheet"></noscript> 
